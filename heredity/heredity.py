...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # If person has no parents, gets unconditional distribution
...
def normalize(probabilities):
    ...
    """
    for person in probabilities:
        tot1 = probabilities[person]["gene"][1] + probabilities[person]["gene"][2] + probabilities[person]["gene"][0]
        for i in range(0,3):
            probabilities[person]["gene"][i] /= tot1

        tot2 = probabilities[person]["trait"][True] + probabilities[person]["trait"][False]
        probabilities[person]["trait"][True] /= tot2
        probabilities[person]["trait"][False] /= tot2
